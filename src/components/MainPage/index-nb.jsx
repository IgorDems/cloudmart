    ...
    <div className="bg-white p-4 rounded-lg shadow-md flex flex-col justify-between h-full">
      ...
      <div>
        ...
        <button
          ...
          className="mt-2 bg-navy-600 text-white py-2 px-4 rounded hover:bg-navy-700 transition-colors w-full"
        >
          Add to Cart
        </button>
      </div>
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="relative">
            <input
              ...
              className="pl-10 pr-4 py-2 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-navy-500 focus:border-transparent"
              value={searchTerm}
